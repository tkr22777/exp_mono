...
"""
from ..db.supabase_client import get_admin_client, get_supabase_client
...
def get_profile_by_id(user_id):
    ...
    try:
        ...
        response = (
            supabase.table(PROFILES_TABLE).select("*").eq("id", user_id).execute()
        )
...
def get_all_profiles():
    ...
    try:
        ...
        response = supabase.table(PROFILES_TABLE).select("*").execute()
...
def create_profile(user):
    ...
    try:
        ...
        supabase = get_supabase_client()
        response = supabase.table(PROFILES_TABLE).insert(profile_data).execute()
