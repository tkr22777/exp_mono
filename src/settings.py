...
# Import pydantic-settings - this is a required dependency
try:
    ...
    print("Error: pydantic-settings is required for this application.")
    print("Please install it using: poetry install")
    print("or manually with: pip install pydantic-settings")
    sys.exit(1) 
