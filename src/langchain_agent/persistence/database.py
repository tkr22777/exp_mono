...
DEFAULT_DB_PATH = os.path.join(os.path.expanduser("~"), ".langchain_agent", "decisions.db")
T = TypeVar("T")
...
class DecisionRepository:
    ...
    def save_chain(self, chain: DecisionChain) -> ChainModel:
        ...
        db_chain = self.session.query(ChainModel).filter_by(chain_id=chain.chain_id).first()
