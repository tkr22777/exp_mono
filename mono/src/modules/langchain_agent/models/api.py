...
class ProcessTextRequest(BaseModel):
    ...
    persist: bool = Field(
        default=False, description="Whether to persist the decision chain"
    )
...
class LangChainDecisionResult(BaseModel):
    ...
    step_count: int = Field(
        ..., description="The number of steps in the decision chain"
    )
...
class ProcessTextResponse(BaseModel):
    ...
    result: Optional[LangChainDecisionResult] = Field(
        None, description="The result of processing"
    )
